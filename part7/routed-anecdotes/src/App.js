...
const Menu = ({ anecdotes, addNew }) => {
  ...
  const onAddNew = (content) => {
    setFlash(`a new anecdote: ${content} created!`)
...
const CreateNewRouted = (props) => {
  ...
  const handleSubmit = (e, props) => {
    ...
    // TODO redirect to newly created
    // TODO clear the fields? do we need after redirect?
    props.onAddNew(content)
    props.history.push('/')
  }
...
const CreateNew = withRouter(CreateNewRouted)
